...
class TraceEventKind(StrEnum):
    ...
    ROLLBACK_ANIMATION_INITIALIZED = "rollback_animation_initialized"
    ROLLBACK_DAG_ANIMATED = "rollback_dag_animated"
    EXECUTION_CHAIN_REPLAYED = "execution_chain_replayed"
    ROLLBACK_RENDER_STABILIZED = "rollback_render_stabilized"
    CAUSALITY_GRAPH_GENERATED = "causality_graph_generated"
    FAILURE_CHAIN_TRACED = "failure_chain_traced"
    RUNTIME_DEPENDENCY_MAPPED = "runtime_dependency_mapped"
    REASONING_PATH_RECONSTRUCTED = "reasoning_path_reconstructed"
    REPLAY_WINDOW_INITIALIZED = "replay_window_initialized"
    COGNITION_TIMELINE_REPLAYED = "cognition_timeline_replayed"
    REPLAY_STATE_CHECKPOINTED = "replay_state_checkpointed"
    REPLAY_DENSITY_THROTTLED = "replay_density_throttled"
    RUNTIME_PRESSURE_PROPAGATED = "runtime_pressure_propagated"
    PRESSURE_DIFFUSION_SIMULATED = "pressure_diffusion_simulated"
    EXECUTION_CONGESTION_DETECTED = "execution_congestion_detected"
    PRESSURE_SURFACES_REBALANCED = "pressure_surfaces_rebalanced"
    OPERATIONAL_TIMELINE_RENDERED = "operational_timeline_rendered"
    TIMELINE_WINDOW_COMPRESSED = "timeline_window_compressed"
    TIMELINE_LAYERS_SYNCHRONIZED = "timeline_layers_synchronized"
    TIMELINE_OVERLAY_GENERATED = "timeline_overlay_generated"
    EXECUTION_STATE_RECONSTRUCTED = "execution_state_reconstructed"
